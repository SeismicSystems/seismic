 ...
 * @property {Function} decodeResult - Function that returns the raw ciphertext bytes from the precompile call.
 */
 ...
 * @property {Function} decodeResult - Function that converts the raw plaintext bytes from the precompile call to a string.
 */
