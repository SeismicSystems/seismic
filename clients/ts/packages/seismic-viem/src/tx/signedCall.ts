...
/**
 * Executes a signed Ethereum call on the Seismic network.
 *
 * This function validates the provided parameters, constructs a Seismic
 * transaction-shaped request, encrypts the calldata, and signs the request with
 * the client's account before sending it to `eth_call`.
 *
 ...
 *
 * @throws {BaseError} If the request is invalid or missing required fields.
