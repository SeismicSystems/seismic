...
Environment variables:
    ...
    SFOUNDRY_ROOT      - path to seismic-foundry repo root (binary: target/debug/sanvil)
    SRETH_ROOT         - path to seismic-reth repo root (binary: target/debug/seismic-reth)
    SEISMIC_WORKSPACE  - fallback: parent dir containing seismic-foundry/ and seismic-reth/
"""
...
def _resolve_binary(
    ...
    raise pytest.UsageError(
        ...
        f"Set {specific_env} (repo root) or SEISMIC_WORKSPACE (parent of all seismic repos).\n"
        f"Example:\n"
