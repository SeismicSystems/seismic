...
- [Confidential Storage Extension for the Ethereum Virtual Machine (EVM)](#confidential-storage-extension-for-the-ethereum-virtual-machine-evm)
    - [Introduction](#introduction)
    - [Table of Contents](#table-of-contents)
    - [1. New Shielded Types](#1-new-shielded-types)
      - [Usage Example](#usage-example)
  - [2. Storage Behavior](#2-storage-behavior)
      - [Assembly Slot Packing Example](#assembly-slot-packing-example)
  ...
  - [5. New Instructions](#5-new-instructions)
    ...
    - [5.2 `CLOAD`](#52-cload)
    - [5.3 Storage Rights Management](#53-storage-rights-management)
