...
| `aes_key`       | [`Bytes32`](../../api-reference/bytes32/) | Yes      | 32-byte AES-256 viewing key                             |
...
* [watch\_src20\_events](watch-src20-events.md) - Factory function with automatic key fetching
* [watch\_src20\_events\_with\_key](watch-src20-events-with-key.md) - Factory function with explicit key
