...
| `private_key`   | [`PrivateKey`](../../api-reference/bytes32/private-key.md) | Yes      | 32-byte signing key for signed reads                          |
...
* [watch\_src20\_events\_with\_key](watch-src20-events-with-key.md) - Watch with explicit viewing key
...
* [register\_viewing\_key](../directory/register-viewing-key.md) - Register a viewing key
* [get\_viewing\_key](../directory/get-viewing-key.md) - Fetch your viewing key
