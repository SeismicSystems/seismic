---
description: >-
  Execute a signed read (eth_call) with encrypted calldata and decrypted
  response
icon: book-open
---
...
<table><thead><tr><th width="400">Sync</th><th>Async</th></tr></thead><tbody><tr><td><pre class="language-python"><code class="lang-python">def signed_call(
    *,
    to: ChecksumAddress,
    data: HexBytes,
    value: int = 0,
...
</code></pre></td><td><pre class="language-python"><code class="lang-python">async def signed_call(
    *,
    to: ChecksumAddress,
    data: HexBytes,
    value: int = 0,
...
* [contract.read](../../../../gitbook/client-libraries/seismic-python/namespaces/contract/namespaces/read.md) — High-level signed read API
* [send\_shielded\_transaction()](send-shielded-transaction.md) — Send write transactions
* [contract.tread](../../../../gitbook/client-libraries/seismic-python/namespaces/contract/namespaces/tread.md) — Transparent reads without encryption
