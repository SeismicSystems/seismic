...
<table><thead><tr><th width="400">Sync</th><th>Async</th></tr></thead><tbody><tr><td><pre class="language-python"><code class="lang-python">def debug_send_shielded_transaction(
    *,
    to: ChecksumAddress,
    data: HexBytes,
    value: int = 0,
...
</code></pre></td><td><pre class="language-python"><code class="lang-python">async def debug_send_shielded_transaction(
    *,
    to: ChecksumAddress,
    data: HexBytes,
    value: int = 0,
...
**Type:** [`DebugWriteResult`](../../api-reference/signature/debug-write-result.md)
...
* [send\_shielded\_transaction()](send-shielded-transaction.md) — Send without debug info
* [contract.dwrite](../../../../gitbook/client-libraries/seismic-python/namespaces/contract/namespaces/dwrite.md) — Debug writes with ABI encoding
* [DebugWriteResult](../../api-reference/signature/debug-write-result.md) — Return type reference
* [UnsignedSeismicTx](../../api-reference/signature/unsigned-seismic-tx.md) — Transaction structure
