...
<table><thead><tr><th width="200">Sync</th><th>Async</th></tr></thead><tbody><tr><td><pre class="language-python"><code class="lang-python">def get_deposit_root(
    *,
    address: str = DEPOSIT_CONTRACT_ADDRESS,
) -> bytes
</code></pre></td><td><pre class="language-python"><code class="lang-python">async def get_deposit_root(
    *,
    address: str = DEPOSIT_CONTRACT_ADDRESS,
) -> bytes
...
* [get\_deposit\_count()](get-deposit-count.md) — Read the total number of deposits
