...
**Returns**: `Coroutine[HexBytes | None]` (encrypted result bytes)
...
**Returns**: `Coroutine[DebugWriteResult]` ([`DebugWriteResult`](../api-reference/signature/debug-write-result.md))
...
* [create\_async\_wallet\_client](../client/create-async-wallet-client.md) - Create async client
