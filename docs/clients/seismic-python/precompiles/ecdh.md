...
| `sk`      | [`PrivateKey`](../api-reference/bytes32/private-key.md)                    | Yes      | 32-byte secret key                        |
| `pk`      | [`CompressedPublicKey`](../api-reference/bytes32/compressed-public-key.md) | Yes      | 33-byte compressed public key             |

## Returns

| Type                                   | Description           |
| -------------------------------------- | --------------------- |
| [`Bytes32`](../api-reference/bytes32/) | 32-byte shared secret |
...
* [CompressedPublicKey](../api-reference/bytes32/compressed-public-key.md) - 33-byte public key type
