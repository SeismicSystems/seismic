...
| ------------------------ | -------------------------------------------------------------------------- | ------------------------------------------------ |
| `aes_key`                | [`Bytes32`](../api-reference/bytes32/)                                     | 32-byte AES-256 key derived from ECDH + HKDF     |
| `encryption_pubkey`      | [`CompressedPublicKey`](../api-reference/bytes32/compressed-public-key.md) | Client's 33-byte compressed secp256k1 public key |
| `encryption_private_key` | [`PrivateKey`](../api-reference/bytes32/private-key.md)                    | Client's 32-byte secp256k1 private key           |
...
| `nonce`     | [`EncryptionNonce`](../api-reference/bytes32/encryption-nonce.md)        | 12-byte AES-GCM nonce                    |
| `metadata`  | [`TxSeismicMetadata`](../api-reference/signature/tx-seismic-metadata.md) | Transaction metadata (used to build AAD) |
...
1. Encode metadata as AAD using [`encode_metadata_as_aad()`](../api-reference/signature/tx-seismic-metadata.md)
...
* [get\_encryption](get-encryption.md) - Derive encryption state from TEE public key
* [create\_wallet\_client](create-wallet-client.md) - Sync client factory (creates EncryptionState)
...
* [TxSeismicMetadata](../api-reference/signature/tx-seismic-metadata.md) - Metadata structure
* [Shielded Write Guide](../../../gitbook/client-libraries/seismic-python/shielded-write.md) - How shielded transactions work
