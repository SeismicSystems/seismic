...
| --------- | ---------------------------------------------------------- | -------- | -------------------------------- |
| `tx`      | [`UnsignedSeismicTx`](../signature/unsigned-seismic-tx.md) | Yes      | The unsigned Seismic transaction |
...
* **name** - `"Seismic Transaction"`
* **version** - `"2"` (matches message\_version)
...
* [sign\_seismic\_tx\_eip712](./) - Signs using this data internally
* [eip712\_signing\_hash](eip712-signing-hash.md) - Computes hash from typed data
* [domain\_separator](domain-separator.md) - Domain component
* [struct\_hash](struct-hash.md) - Message component
