...
| `encryption_nonce`  | [`EncryptionNonce`](../bytes32/encryption-nonce.md) `\| None` | `None` (→ random)   | Explicit AES-GCM nonce                          |
| `recent_block_hash` | [`Bytes32`](../bytes32/) `\| None`                            | `None` (→ latest)   | Explicit block hash for freshness proof         |
...
### blocks\_window vs expires\_at\_block
...
### recent\_block\_hash and expires\_at\_block
...
* [EncryptionNonce](../bytes32/encryption-nonce.md) - Type for encryption\_nonce field
* [Bytes32](../bytes32/) - Type for recent\_block\_hash field
