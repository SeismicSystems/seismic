...
### Extract from eth\_keys Signature
...
* Used internally by [`sign_seismic_tx_eip712`](../sign-seismic-tx-eip712/)
* Part of the final RLP-encoded transaction

## See Also

* [sign\_seismic\_tx\_eip712](../sign-seismic-tx-eip712/) - Creates and applies signature
* [UnsignedSeismicTx](unsigned-seismic-tx.md) - Transaction before signing
* [PrivateKey](../bytes32/private-key.md) - Used to generate signatures
