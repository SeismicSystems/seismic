...
| ------------------- | ------------------------------------------------------------ | -------------------------------------------------------------------- |
| `encryption_pubkey` | [`CompressedPublicKey`](../bytes32/compressed-public-key.md) | Compressed secp256k1 public key for ECDH-derived calldata encryption |
| `encryption_nonce`  | [`EncryptionNonce`](../bytes32/encryption-nonce.md)          | 12-byte AES-GCM nonce for encryption                                 |
| `message_version`   | `int`                                                        | Signing mode — `0` for raw, `2` for EIP-712                          |
| `recent_block_hash` | [`Bytes32`](../bytes32/)                                     | Hash of a recent block (freshness proof)                             |
...
* [CompressedPublicKey](../bytes32/compressed-public-key.md) - Type for encryption\_pubkey
* [EncryptionNonce](../bytes32/encryption-nonce.md) - Type for encryption\_nonce
* [Bytes32](../bytes32/) - Type for recent\_block\_hash
