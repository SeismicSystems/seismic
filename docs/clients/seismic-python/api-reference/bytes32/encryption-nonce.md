...
* Used in [`SeismicElements`](../signature/seismic-elements.md) for `encryption_nonce`
* Auto-generated by the SDK if not specified in [`SeismicSecurityParams`](../signature/seismic-security-params.md)
...
* [SeismicElements](../signature/seismic-elements.md) - Uses EncryptionNonce
* [SeismicSecurityParams](../signature/seismic-security-params.md) - Optional nonce override
* [aes\_gcm\_encrypt](../../precompiles/aes-gcm-encrypt.md) - AES-GCM encryption with nonce
* [aes\_gcm\_decrypt](../../precompiles/aes-gcm-decrypt.md) - AES-GCM decryption with nonce
