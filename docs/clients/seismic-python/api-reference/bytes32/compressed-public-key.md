...
* Used in [`SeismicElements`](../signature/seismic-elements.md) for `encryption_pubkey`
...
* [Bytes32](./) - General 32-byte type
* [SeismicElements](../signature/seismic-elements.md) - Uses CompressedPublicKey for encryption
* [ecdh](../../precompiles/ecdh.md) - ECDH key derivation with public keys
* [get\_tee\_public\_key](../../namespaces/methods/get-tee-public-key.md) - Retrieve TEE public key
