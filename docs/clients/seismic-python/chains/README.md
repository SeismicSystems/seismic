...
| [SEISMIC\_TESTNET](seismic-testnet.md)            | Public testnet configuration (GCP-1)          |
| [SANVIL](sanvil.md)                               | Local development network configuration       |
| [make\_seismic\_testnet](make-seismic-testnet.md) | Factory for alternate testnet instances       |

### Protocol Constants

| Constant                                | Description                                    |
| --------------------------------------- | ---------------------------------------------- |
| [SEISMIC\_TX\_TYPE](seismic-tx-type.md) | Transaction type byte for Seismic transactions |
...
* [PrivateKey](../api-reference/bytes32/private-key.md) - Private key type documentation
