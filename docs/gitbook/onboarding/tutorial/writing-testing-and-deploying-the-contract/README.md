...
* [**Chapter 2: Making the Shell and Revealing the Kernel**](chapter-2-making-the-shell-and-revealing-the-kernel.md)
...
* [**Chapter 3: Reset Mechanism, Rounds, and a more conditional Kernel Reveal**](chapter-3-reset-mechanism-rounds-and-a-more-conditional-kernel-reveal.md)
