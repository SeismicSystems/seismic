...
- Commonly used for block hashes in [`SeismicElements`](../transaction-types/seismic-elements.md)
...
- [SeismicElements](../transaction-types/seismic-elements.md) - Uses Bytes32 for `recent_block_hash`
