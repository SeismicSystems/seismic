...
- [`eth_call`](../reference/rpc-methods/eth-call.md) — zeroes the `from` field on unsigned calls; supports ["signed reads"](../reference/seismic-transaction.md#signed-reads) via type `0x4A`
