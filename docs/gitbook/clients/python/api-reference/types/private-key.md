...
`PrivateKey` is a specialized [`Bytes32`](bytes32.md) type representing a secp256k1 private key. It's used for transaction signing and deriving shared secrets via ECDH.
...
- Inherits from [`Bytes32`](bytes32.md)
