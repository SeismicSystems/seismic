...
`make_seismic_testnet(n)` generates a chain configuration for GCP testnet instance *n*. This is useful when you need to connect to alternate testnet instances beyond the default [`SEISMIC_TESTNET`](seismic-testnet.md) (which is GCP-1).
...
- [SEISMIC_TESTNET](seismic-testnet.md) - Pre-defined testnet (GCP-1)
