...
| **[Types](api-reference/types/)** | Primitive types (Bytes32, PrivateKey, etc.) |
| **[Transaction Types](api-reference/transaction-types/)** | Seismic transaction dataclasses |
| **[EIP-712](api-reference/eip712/)** | EIP-712 typed data signing functions |
...
- **Client factories** → [create_wallet_client](client/create-wallet-client.md), [create_public_client](client/create-public-client.md)
...
- **Transaction types** → [UnsignedSeismicTx](api-reference/transaction-types/unsigned-seismic-tx.md), [SeismicElements](api-reference/transaction-types/seismic-elements.md)
