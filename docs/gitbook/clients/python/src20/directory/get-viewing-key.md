...
| `private_key` | [`PrivateKey`](../../api-reference/types/private-key.md) | Yes | 32-byte signing key for authentication |
...
2. **Signed read** - Calls [`signed_call()`](../../api-reference/eip712/sign-seismic-tx-eip712.md) to the Directory contract at `0x1000...0004`
...
- [register_viewing_key](register-viewing-key.md) - Register a viewing key in Directory
