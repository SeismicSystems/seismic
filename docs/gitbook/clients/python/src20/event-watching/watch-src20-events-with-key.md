...
| `viewing_key` | [`Bytes32`](../../api-reference/types/bytes32.md) | Yes | 32-byte AES-256 viewing key |
...
- [get_viewing_key](../directory/get-viewing-key.md) - Fetch viewing key from Directory
